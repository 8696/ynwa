...
export default function NotFound() {
  ...
  return (
    <main className="max-w-[784px] mx-auto px-8 flex-1 w-full flex items-center">
      <section className="w-full py-20 md:py-28 text-center">
        ...
        <h1 className="text-[56px] font-semibold tracking-[-0.03em] leading-none mb-3">404</h1>
        <p className="text-[24px] font-semibold tracking-[-0.02em] leading-tight mb-3">页面不存在</p>
